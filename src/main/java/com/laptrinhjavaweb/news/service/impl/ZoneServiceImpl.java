...
public class ZoneServiceImpl implements ZoneService {
    ...
    public ZoneDocument createZone(ZoneInput input) {
        ...
        List<Point> points = input.getCoordinates().get(0).stream()
    ...
    public ZoneDocument update(String id, ZoneDocument input) {
        ZoneDocument existing =
                zoneRepository.findById(id).orElseThrow(() -> new AppException(ErrorCode.ZONE_NOT_EXISTED));
